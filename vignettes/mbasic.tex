...
\hlstd{fit.mbasic} \hlkwb{<-} \hlkwd{MBASIC.pipeline}\hlstd{(}\hlkwc{chipfile} \hlstd{= tbl}\hlopt{$}\hlstd{chipfile,}
    ...
    \hlkwc{fac} \hlstd{= conds,} \hlkwc{J} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{S} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{family} \hlstd{=} \hlstr{"negbin"}\hlstd{,} \hlkwc{datafile} \hlstd{=} \hlstr{"data.Rda"}\hlstd{)}
\hlkwd{class}\hlstd{(fit.mbasic)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{allfits.mbasic} \hlkwb{<-} \hlkwd{MBASIC.pipeline}\hlstd{(}\hlkwc{chipfile} \hlstd{= tbl}\hlopt{$}\hlstd{chipfile,}
    \hlkwc{inputfile} \hlstd{= tbl}\hlopt{$}\hlstd{inputfile,} \hlkwc{input.suffix} \hlstd{=} \hlstr{".bed"}\hlstd{,}
    \hlkwc{target} \hlstd{= target,} \hlkwc{chipformat} \hlstd{= tbl}\hlopt{$}\hlstd{chipformat,} \hlkwc{inputformat} \hlstd{= tbl}\hlopt{$}\hlstd{inputformat,}
    \hlkwc{fragLen} \hlstd{=} \hlnum{150}\hlstd{,} \hlkwc{pairedEnd} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{unique} \hlstd{=} \hlnum{TRUE}\hlstd{,}
    ...
    \hlkwc{datafile} \hlstd{=} \hlstr{"data.Rda"}\hlstd{,} \hlkwc{method} \hlstd{=} \hlstr{"mbasic"}\hlstd{)}
\hlkwd{names}\hlstd{(allfits.mbasic)}
\end{alltt}
\begin{verbatim}
## [1] "allFits" "BestFit" "Time"
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(allfits.mbasic}\hlopt{$}\hlstd{BestFit)}
\end{alltt}
\begin{verbatim}
## [1] "MBASICFit"
## attr(,"package")
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{allfits.madbayes} \hlkwb{<-} \hlkwd{MBASIC.pipeline}\hlstd{(}\hlkwc{chipfile} \hlstd{= tbl}\hlopt{$}\hlstd{chipfile,}
    \hlkwc{inputfile} \hlstd{= tbl}\hlopt{$}\hlstd{inputfile,} \hlkwc{input.suffix} \hlstd{=} \hlstr{".bed"}\hlstd{,}
    \hlkwc{target} \hlstd{= target,} \hlkwc{chipformat} \hlstd{= tbl}\hlopt{$}\hlstd{chipformat,} \hlkwc{inputformat} \hlstd{= tbl}\hlopt{$}\hlstd{inputformat,}
    \hlkwc{fragLen} \hlstd{=} \hlnum{150}\hlstd{,} \hlkwc{pairedEnd} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{unique} \hlstd{=} \hlnum{TRUE}\hlstd{,}
    \hlkwc{fac} \hlstd{= conds,} \hlkwc{J} \hlstd{=} \hlnum{3}\hlopt{:}\hlnum{10}\hlstd{,} \hlkwc{S} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{datafile} \hlstd{=} \hlstr{"data.Rda"}\hlstd{,}
    \hlkwc{method} \hlstd{=} \hlstr{"madbayes"}\hlstd{)}
\hlkwd{names}\hlstd{(allfits.madbayes)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(allfits.madbayes}\hlopt{$}\hlstd{BestFit)}
\end{alltt}
\begin{verbatim}
## [1] "MBASICFit"
## attr(,"package")
...
\hlstd{fit.mbasic} \hlkwb{<-} \hlkwd{MBASIC}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),} \hlkwc{Gamma} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{input),}
...
\hlcom{## Step 3: Fit multiple MBASIC models simultaneously}
\hlstd{allfits.mbasic} \hlkwb{<-} \hlkwd{MBASIC.full}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),} \hlkwc{Gamma} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{input),}
...
\hlstd{fit.mbasic} \hlkwb{<-} \hlstd{allfits.mbasic}\hlopt{$}\hlstd{BestFit}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{allfits.madbayes} \hlkwb{<-} \hlkwd{MBASIC.MADBayes.full}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{log}\hlstd{(}\hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip)} \hlopt{+}
    \hlnum{1}\hlstd{),} \hlkwc{Gamma} \hlstd{=} \hlkwd{log}\hlstd{(}\hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{input)} \hlopt{+} \hlnum{1}\hlstd{),} \hlkwc{S} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{fac} \hlstd{= conds,}
    \hlkwc{maxitr} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{ncores} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{nlambdas} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{nfits} \hlstd{=} \hlnum{1}\hlstd{)}
\hlstd{fit.madbayes} \hlkwb{<-} \hlstd{allfits.madbayes}\hlopt{$}\hlstd{BestFit}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{pred.states} \hlkwb{<-} \hlkwd{as.character}\hlstd{(}\hlkwd{apply}\hlstd{(fit.mbasic}\hlopt{@}\hlkwc{Theta}\hlstd{[}\hlkwd{rownames}\hlstd{(fit.mbasic}\hlopt{@}\hlkwc{Theta}\hlstd{)} \hlopt{==}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mincount.thresholds} \hlkwb{<-} \hlkwd{apply}\hlstd{(dat}\hlopt{$}\hlstd{input,} \hlnum{2}\hlstd{,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)} \hlkwd{quantile}\hlstd{(x,}
    \hlnum{0.25}\hlstd{))} \hlopt{*} \hlkwd{apply}\hlstd{(dat}\hlopt{$}\hlstd{depth,} \hlnum{1}\hlstd{,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{) x[}\hlnum{1}\hlstd{]}\hlopt{/}\hlstd{x[}\hlnum{2}\hlstd{])}
\hlstd{mincount.thresholds} \hlkwb{<-} \hlkwd{as.integer}\hlstd{(mincount.thresholds)}
\hlstd{mincount.thresholds[mincount.thresholds} \hlopt{<} \hlnum{5}\hlstd{]} \hlkwb{<-} \hlnum{5}
\hlkwd{summary}\hlstd{(mincount.thresholds)}
\end{alltt}
\begin{verbatim}
...
\hlstd{fit.update} \hlkwb{<-} \hlkwd{MBASIC}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),} \hlkwc{Gamma} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{input),}
    \hlkwc{S} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{fac} \hlstd{= conds,} \hlkwc{J} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{maxitr} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{family} \hlstd{=} \hlstr{"negbin"}\hlstd{,}
    \hlkwc{initial} \hlstd{= fit.mbasic)}
\end{alltt}
\end{kframe}
\end{knitrout}

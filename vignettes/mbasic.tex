...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: cluster\\\#\# Loading required package: doMC\\\#\# Loading required package: foreach\\\#\# Loading required package: iterators\\\#\# Loading required package: parallel\\\#\# Loading required package: GenomicRanges\\\#\# Loading required package: BiocGenerics\\\#\# \\\#\# Attaching package: 'BiocGenerics'\\\#\# \\\#\# The following objects are masked from 'package:parallel':\\\#\# \\\#\#\ \ \ \  clusterApply, clusterApplyLB,\\\#\#\ \ \ \  clusterCall, clusterEvalQ,\\\#\#\ \ \ \  clusterExport, clusterMap, parApply,\\\#\#\ \ \ \  parCapply, parLapply, parLapplyLB,\\\#\#\ \ \ \  parRapply, parSapply, parSapplyLB\\\#\# \\\#\# The following object is masked from 'package:stats':\\\#\# \\\#\#\ \ \ \  xtabs\\\#\# \\\#\# The following objects are masked from 'package:base':\\\#\# \\\#\#\ \ \ \  anyDuplicated, append, as.data.frame,\\\#\#\ \ \ \  as.vector, cbind, colnames, duplicated,\\\#\#\ \ \ \  eval, evalq, Filter, Find, get,\\\#\#\ \ \ \  intersect, is.unsorted, lapply, Map,\\\#\#\ \ \ \  mapply, match, mget, order, paste, pmax,\\\#\#\ \ \ \  pmax.int, pmin, pmin.int, Position,\\\#\#\ \ \ \  rank, rbind, Reduce, rep.int, rownames,\\\#\#\ \ \ \  sapply, setdiff, sort, table, tapply,\\\#\#\ \ \ \  union, unique, unlist\\\#\# \\\#\# Loading required package: IRanges\\\#\# Loading required package: XVector\\\#\# Loading required package: gtools\\\#\# Loading required package: MASS\\\#\# Loading required package: mclust\\\#\# Package 'mclust' version 4.4\\\#\# Type 'citation("{}mclust"{})' for citing this R package in publications.\\\#\# \\\#\# Attaching package: 'mclust'\\\#\# \\\#\# The following object is masked from 'package:GenomicRanges':\\\#\# \\\#\#\ \ \ \  map\\\#\# \\\#\# The following object is masked from 'package:IRanges':\\\#\# \\\#\#\ \ \ \  map\\\#\# \\\#\# Loading required package: msm\\\#\# Loading required package: Rcpp}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: replacing previous import by 'mclust::map' when loading 'MBASIC'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep1.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep2.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep3.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep1.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep2.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac1CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac2CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac2CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac3CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac3CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac4CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac5CtrlAlnRep1.bed}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep1.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep2.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell1InputCtrlAlnRep3.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep1.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep2.bed\\\#\# processing input file syntheticData/input/wgEncodeLabExpCell2InputCtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac1CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac2CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac3CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac4CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell1Fac5CtrlAlnRep3.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac1CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac2CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac2CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac3CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac3CtrlAlnRep2.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac4CtrlAlnRep1.bed\\\#\# processing chip file syntheticData/chip/wgEncodeLabExpCell2Fac5CtrlAlnRep1.bed\\\#\# processing chr1\\\#\# read mappability file\\\#\# read gc file\\\#\# processing chr5\\\#\# read mappability file\\\#\# read gc file\\\#\# processing chr4\\\#\# read mappability file\\\#\# read gc file\\\#\# processing chr2\\\#\# read mappability file\\\#\# read gc file\\\#\# processing chr3\\\#\# read mappability file\\\#\# read gc file}}\end{kframe}
\end{knitrout}
...
\hlstd{fit.update} \hlkwb{<-} \hlkwd{MBASIC}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),} \hlkwc{Gamma} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{input),}
    \hlkwc{S} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{fac} \hlstd{= conds,} \hlkwc{J} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{maxitr} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{family} \hlstd{=} \hlstr{"negbin"}\hlstd{,}
    \hlkwc{Mu.init} \hlstd{= fit}\hlopt{@}\hlkwc{Mu}\hlstd{,} \hlkwc{Sigma.init} \hlstd{= fit}\hlopt{@}\hlkwc{Sigma}\hlstd{,} \hlkwc{V.init} \hlstd{= fit}\hlopt{@}\hlkwc{V}\hlstd{,}
    \hlkwc{ProbMat.init} \hlstd{= fit}\hlopt{@}\hlkwc{Theta}\hlstd{,} \hlkwc{W.init} \hlstd{= fit}\hlopt{@}\hlkwc{W}\hlstd{,} \hlkwc{Z.init} \hlstd{= fit}\hlopt{@}\hlkwc{Z}\hlstd{,}
    \hlkwc{b.init} \hlstd{= fit}\hlopt{@}\hlkwc{b}\hlstd{,} \hlkwc{P.init} \hlstd{= fit}\hlopt{@}\hlkwc{P}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}

\subsection{Multiple Components in a State}
...
\hlkwd{MBASIC.binary}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),}  \hlkwc{Mu0} \hlstd{=} \hlkwd{t}\hlstd{(Mu0),}
              \hlkwc{fac} \hlstd{= conds,}  \hlkwc{J}\hlstd{=}\hlnum{4}\hlstd{,}  \hlkwc{zeta}\hlstd{=}\hlnum{0.2}\hlstd{,}
              \hlkwc{maxitr} \hlstd{=} \hlnum{100}\hlstd{,} \hlkwc{burnin} \hlstd{=} \hlnum{20}\hlstd{,}
              \hlkwc{init.mod} \hlstd{= fit,}
              \hlkwc{struct} \hlstd{=} \hlkwa{NULL}\hlstd{,} \hlkwc{family}\hlstd{=}\hlstr{"negbin"}\hlstd{,}
              \hlkwc{tol} \hlstd{=} \hlnum{1e-4}\hlstd{,}  \hlkwc{nsig} \hlstd{=} \hlnum{2}\hlstd{)}

\hlcom{## Fit a MBASIC model with more iterations}
\hlkwd{MBASIC.binary}\hlstd{(}\hlkwc{Y} \hlstd{=} \hlkwd{t}\hlstd{(dat}\hlopt{$}\hlstd{chip),}  \hlkwc{Mu0} \hlstd{=} \hlkwd{t}\hlstd{(Mu0),}
              \hlkwc{fac} \hlstd{= conds,}  \hlkwc{J}\hlstd{=}\hlnum{3}\hlstd{,}  \hlkwc{zeta}\hlstd{=}\hlnum{0.2}\hlstd{,}
              \hlkwc{maxitr} \hlstd{=} \hlnum{200}\hlstd{,} \hlkwc{burnin} \hlstd{=} \hlnum{20}\hlstd{,}
              \hlkwc{init.mod} \hlstd{= fit,}
              \hlkwc{struct} \hlstd{=} \hlkwa{NULL}\hlstd{,} \hlkwc{family}\hlstd{=}\hlstr{"negbin"}\hlstd{,}
              \hlkwc{tol} \hlstd{=} \hlnum{1e-4}\hlstd{,}  \hlkwc{nsig} \hlstd{=} \hlnum{2}\hlstd{)}
\end{alltt}
